...
from app1.forms.forms import FacultyForm, FacultyLoginForm
from app1.oper.oper import check_faculty_exists, add_faculty
from flask_bcrypt import Bcrypt
from flask_login import login_user
from app1.models.models import Faculty
